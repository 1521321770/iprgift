...
<script type="text/javascript" src="../../gift/gift/gift.js"></script>
</head>
<body>
<!-- 底层panel start-->
<div id="wrapper" class="clearfix">
                      ...
                      <ul id="">
                          <li  class="active left_first_li" id="">
                              ...
                              <ul>
                                ...
                                <li class="intercurrent"><a href="../gift/gift.jsp">礼物列表</a></li>
                              </ul>
                           </li>                      
                          <li id="">
                              <a href="#">
	...
	<div id="right_layout" class="clearfix">
		<div id="listViewContentPanel" class="container-fluid">
			...
			<!--当前位置 start-->        
			<div  class="curposition mt8 clearfix">生日礼物 &gt;  礼物  &gt;  礼物列表:</div>
         	<!--当前位置 end-->
         ...
         <div id="example" class="table_panel mt10 clearfix">
              <table id="dataTable_gift" class="table table-content table-hover idatatable">
                  <thead>
                    <tr>
                      ...
                      <th class="sorting" style="vertical-align:middle;"><span>图片</span><span class="column-sorter"></span></th>
                      <th class="sorting" style="vertical-align:middle;"><span>地方</span><span class="column-sorter"></span></th>
                      <th class="sorting" style="vertical-align:middle;"><span>描述</span><span class="column-sorter"></span></th>
