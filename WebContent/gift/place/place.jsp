...
<script type="text/javascript" src="../../gift/place/place.js"></script>
</head>
<body>
<!-- 底层panel start-->
<div id="wrapper" class="clearfix">
                      ...
                      <ul id="">
                          <li  class="active left_first_li" id="">
                              ...
                              <ul>
                                ...
                                <li class="intercurrent"><a href="../place/place.jsp">工作地列表</a></li>
	...
	<div id="right_layout" class="clearfix">
		<div id="listViewContentPanel" class="container-fluid">
			...
			<!--当前位置 start-->        
			<div  class="curposition mt8 clearfix">生日礼物 &gt;  礼物  &gt;  工作地列表:</div>
         	<!--当前位置 end-->
         ...
         <div id="example" class="table_panel mt10 clearfix">
              <table id="dataTable_place" class="table table-content table-hover idatatable">
                  <thead>
                    <tr>
